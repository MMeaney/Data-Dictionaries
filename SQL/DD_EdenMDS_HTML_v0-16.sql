...
--		 'SELECT TOP 1 * FROM ' + '[' + SCHEMA_NAME(schema_id) + '].[' + name + '];'
--	FROM  sys.tables	T
--	INNER JOIN sys.types TP ON TP. = T.system_type_id
...
BEGIN
	...
	SELECT  @sql2 = @sql2 + 
		 'SELECT TOP 2 * FROM ' + '[' + SCHEMA_NAME(schema_id) + '].[' + name + ']' + 'EXCEPT SELECT TOP 1 * FROM [' + SCHEMA_NAME(schema_id) + '].[' + name + '];'
	FROM  sys.tables
	WHERE name = @EntityName
...
BEGIN
	...
	SELECT  @sql3 = @sql3 + 
		 'SELECT TOP 3 * FROM ' + '[' + SCHEMA_NAME(schema_id) + '].[' + name + ']' + 'EXCEPT SELECT TOP 2 * FROM [' + SCHEMA_NAME(schema_id) + '].[' + name + '];'
	FROM  sys.tables
	WHERE name = @EntityName
