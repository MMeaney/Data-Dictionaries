...
'
 ...
 .entitydataatablenametd   {background:#F5F5F5;}
...
<thead>
	<tr>
		  ...
		  <td class = "entitydatanametd", colspan = "10"><div id = "' + @EntityName + '">' + @EntityName + '</div></td>
	 </tr>'
...
SELECT
	...
	'		<td class = "entitydataatablenametd">' + CAST(SYSTBL.name AS VARCHAR(50)) + '</td>
...
PRINT '	<tr class = "trlinktop">
		<td colspan = "11"><span class = "linktop"><a href="#reportlinks">[Top]</a></span>		</td>
	</tr>
</tfoot>'
