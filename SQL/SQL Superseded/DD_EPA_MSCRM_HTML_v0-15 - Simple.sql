...
AND	  SO1.Name	  IN	('AccountBase'
,'AccountExtensionBase'
,'epa_contactsiteExtensionBase'
,'epa_contactsiteBase'
,'lema_licencecontactExtensionBase'
,'lema_licencetransfer_contact_ptcontactsExtensionBase'
,'epa_siteExtensionBase'
,'epa_siteBase'
,'PnP_siteExtensionBase'
,'PnP_siteBase'
,'dww_siteBase'
,'dww_siteExtensionBase'
)
