-- *********************************************************************************
-- *** Data Dictionary Generation Script
-- *** Incorporates HTML and CSS formatting
-- *** Developed by: Maurice Meaney
-- *** Rev: 19
-- *** Notes: Set 'Results to text'. Copy entire result and paste to HTML file
-- *** Date: 2016/10/21
-- *********************************************************************************
...
AND	  SO1.Name	  NOT IN	('sysdiagrams', 'dtproperties')
AND NOT
(
-- MDS
	...
	OR	SO1.Name LIKE '%CWMonitoredEntities%'
	OR	SO1.Name LIKE '%dwSchemes2009%'
	OR	SO1.Name LIKE '%FCT_Station%'
	OR	SO1.Name LIKE '%FCTCoordinates170214%'
	OR	SO1.Name LIKE '%LWMonitoredEntities%'
	OR	SO1.Name LIKE '%RWMonitoredEntities%'
	OR	SO1.Name LIKE '%TWMonitoredEntities%'
	OR	SO1.Name LIKE '%UWWDischargeStations%'
	OR	SO1.Name LIKE '%UWWInfluentEffluentLinkages%'
	OR	SO1.Name LIKE '%UWWInfluentStations%'
	OR	SO1.Name LIKE '%UWWMonitoredEntities%'
	OR	SO1.Name LIKE '%WFDStationAndWaterBodyCodes2711%'

-- AER
	OR	SO1.Name LIKE '%_OLDFacilityMainNACECodes%'
	OR	SO1.Name LIKE '%_OLDFacilityNACECodes%'
	OR	SO1.Name LIKE '%_temp%'
	OR	SO1.Name LIKE '%PRTRMailMerge_OLD%'
	OR	SO1.Name LIKE '%PRTRMailMerge_v1%'
	OR	SO1.Name LIKE '%PRTRMailMerge12Apr10%'
	OR	SO1.Name LIKE '%PRTRMailMerge2007%'
	OR	SO1.Name LIKE '%PRTRMailMerge2008%'
	OR	SO1.Name LIKE '%PRTRMailMerge2009%'
	OR	SO1.Name LIKE '%PRTRMailMerge201104%'
	OR	SO1.Name LIKE '%PRTRMailMergeKeep%'
	OR	SO1.Name LIKE '%Sheet1$%'
	OR	SO1.Name LIKE '%tbContact19-03-08%'
	OR	SO1.Name LIKE '%tbContact27-03-08%'
	OR	SO1.Name LIKE '%tbContact28-05-08%'
	OR	SO1.Name LIKE '%tbContactAfterImport20121004%'
	OR	SO1.Name LIKE '%tbEUReportConfigOLD%'
	OR	SO1.Name LIKE '%tbEUReportControlOLD%'
	OR	SO1.Name LIKE '%tbMeasurement27-05-08%'
	OR	SO1.Name LIKE '%tbMeasurementExtraData27-05-08%'
	OR	SO1.Name LIKE '%tbParameter27-01-09%'
	OR	SO1.Name LIKE '%tbPRTRFacilityClass20091201%'
	OR	SO1.Name LIKE '%tbPRTRFacilityYear9-6-15%'
	OR	SO1.Name LIKE '%tbPRTRWasteTransfer27-05-08%'
	OR	SO1.Name LIKE '%tbSample27-05-08%'
	OR	SO1.Name LIKE '%TempFacility%'
	OR	SO1.Name LIKE '%TempParsedAddresses%'
	OR	SO1.Name LIKE '%TempTable2#%'
	OR	SO1.Name LIKE '%VW_PRTRFacility20090922%'

-- EPA
	OR	SO1.Name LIKE '%_2009_GHG_AIERDetails_Dups%'
	OR	SO1.Name LIKE '%DELETE%'
	OR	SO1.Name LIKE '%_FTPTesterLog%'
	OR	SO1.Name LIKE '%_TempODWN_DWNotification%'
	OR	SO1.Name LIKE '%20121102_Que_NotifActions%'
	OR	SO1.Name LIKE '%20130807_ipc_AppStatusHistType%'
	OR	SO1.Name LIKE '%DW2009_279_Que_NotifActions%'
	OR	SO1.Name LIKE '%ipc_AppStatusHistory_Removed%'
	OR	SO1.Name LIKE '%ipc_AppStatusHistory23-07-07%'
	OR	SO1.Name LIKE '%ipc_AppStatusHistoryP098001%'
	OR	SO1.Name LIKE '%ipc_LicenceSubStatus101209%'
	OR	SO1.Name LIKE '%ipc_Organisation090209%'
	OR	SO1.Name LIKE '%ipc_Templates_20140902%'
	OR	SO1.Name LIKE '%ipc_Templates20100309%'
	OR	SO1.Name LIKE '%Licenses_P098001%'
	OR	SO1.Name LIKE '%Licenses260805%'

-- EPA_Central_Aquarius
	OR	SO1.Name LIKE '%Bathingwater_06102011%'
	OR	SO1.Name LIKE '%LakeStation_20111011%'
	OR	SO1.Name LIKE '%Parameter_20120510%'
	OR	SO1.Name LIKE '%Parameter07July%'
	OR	SO1.Name LIKE '%schemesyears_060312%'
	OR	SO1.Name LIKE '%UnitOfMeasureGroupMembership_201%'
	OR	SO1.Name LIKE '%MonitoredLocation_201%'
	OR	SO1.Name LIKE '%ParameterGroupMembership_201%'
	OR	SO1.Name LIKE '%Container201%'

-- flexitms
	OR	SO1.Name LIKE '%Bk20091014%'
	OR	SO1.Name LIKE '%TASProjects_2015_new%'
	OR	SO1.Name LIKE '%TASProjects_new%'
	OR	SO1.Name LIKE '%TASProjects_NkUp_20150202%'
	OR	SO1.Name LIKE '%TASProjects26-01-09%'
 	
-- recyclers2
	OR	SO1.Name LIKE '%tblflows_20120914'
	OR	SO1.Name LIKE '%tblOrganisations_20130611%'
	OR	SO1.Name LIKE 'temp%'

-- WstLic
	OR	SO1.Name LIKE '%_DOG_HD107219%'
	OR	SO1.Name LIKE '%_TempLEMAWWDALicences%'
	OR	SO1.Name LIKE '%20120104_LicDat_Notes%'
	OR	SO1.Name LIKE '%tblDMSwasteOtherActivities20060424%'
	OR	SO1.Name LIKE '%wst_AppStatusHistory24-07-07%'
	OR	SO1.Name LIKE '%wst_DocTemplates20100218%'
	OR	SO1.Name LIKE '%wst_Licenses24-07-07%'
	OR	SO1.Name LIKE '%wst_Ref_CertsTemplates20100218%'
	OR	SO1.Name LIKE '%wst_WWD_LicenceActions__TEMPAON22Feb13%'
	OR	SO1.Name LIKE '%wst_WWD_LicenceActions_TEMPBK17Jun08%'
	OR	SO1.Name LIKE '%wst_WWD_LicenceActions11052012%'
	OR	SO1.Name LIKE '%wst_WWD_LicenceActions18-04-08%'
	OR	SO1.Name LIKE '%wst_WWD_Licences_TEMPBK17Jun08%'
	OR	SO1.Name LIKE '%wst_WWD_licences11052012%'
	OR	SO1.Name LIKE '%wst_WWD_Ref_Templates20100218%'
	OR	SO1.Name LIKE '%wst_WWD_SpecifiedBodies20100714%'
	OR	SO1.Name LIKE '%wst_WWD_TEMPLicenceActions_AONFeb13%'
	OR	SO1.Name LIKE '%WstEnf_ChargeHistoryBckup18feb%'
	OR	SO1.Name LIKE '%_DEL'
)
...
-- *** End: List of STORED PROCEDURES with dependencies and the tables they are dependent on
-- ****************************************************************************************************
...
'@media print, screen {
 a      {color: #0099FF;}
 body	{background:#FFFFFF; color:#000000; font-family:sans-serif; word-break: break-all;}
 ...
 .entitydatadiv     {display:inline-block; overflow:hidden;}
 ...
 .entitydataviewtr      {font-size:12px; white-space: pre-wrap;}
 .entitydatasproctr     {font-size:12px; white-space: pre-wrap;}
 .entitydatafunctr      {font-size:12px; white-space: pre-wrap;}
 ...
 .footheader_dep_samplerows	{background:#FFF5E0;}

 .footheader_dep_table, .footheader_dep_view, .footheader_dep_function, .footheader_dep_storedproc, .footheader_dep_samplerows
    {text-align:left; font-size:12px;}
 	
 .footdetail_dep_table, .footdetail_dep_view, .footdetail_dep_function, .footdetail_dep_storedproc, .footdetail_dep_samplerows
...
<div id = "reportlinks">
	 <span><a href="#entityhasfk">Tables</a></span> | 
	 <span><a href="#entityviews">Views</a></span> | 
	 <span><a href="#entitystoredprocedures">Stored Procedures</a></span> | 
...
-- ****************************************************************************************************
-- ****************************************************************************************************
-- TABLES - ALL (2015-10-20: All tables amalgamated)
-- ****************************************************************************************************
-- ****************************************************************************************************


-- *** Begin TOC: Display list of all tables in the database

PRINT '

<div id = "entityhasfk">
<table class = "entitydesctbl">
    <tr class = "entitydescheadtr"><td colspan = "2">Tables</td></tr>
    <tr class = "entitydesctr">
        <td>Tables within the <i>'
...
-- *** End TOC: Display list of all tables in the database

-- *** End: Report Title and tables TOC
...
-- *** Begin constraint: Restrict tables displayed - must be related to another table (2015-10-20: Related and unrelated tables amalgamated)
...
-- *** End constraint: Restrict tables displayed - must be related to another table (2015-10-20: Related and unrelated tables amalgamated)
...
<thead>
	 <tr>
		  <th colspan = "1", white-space: nowrap><b>Table Name: </b></th>
		  <td class = "entitydatanametd", colspan = "9"><div id = "' + @EntityName + '">' + @EntityName + '</div></td>
	 </tr>'

-- *** Table Description - Characters 1-250
PRINT '	<tr>
		  <th colspan = "1", white-space: nowrap><i><b>Table Description: </b></i></th>
...
-- *** Table System
PRINT '	<tr>
		  <th colspan = "1", white-space: nowrap><i>Table System: </i></th>
...
-- *** End: Display the table data dictionary-- *** Begin: Display ENTITIES dependent on the featured table
...
PRINT ' <tr class = "footheader_dep_table">
		  <td colspan = "10"><i><b>Tables</b> in</i> ' + @DatabaseName + ' <i>dependent on </i><b>' + @EntityName + '</b><i>:'
...
PRINT ' <tr class = "footheader_dep_view">
		  <td colspan = "10"><i><b>Views</b> in</i> ' + @DatabaseName + ' <i>dependent on </i><b>' + @EntityName + '</b><i>:'
...
PRINT ' <tr class = "footheader_dep_samplerows">
		  <td colspan = "10"><b><i>Records</i></b> in <b>' + @EntityName + '</b>: <i> '
		  
DECLARE @CountRowsOut	VARCHAR(MAX) = '';
DECLARE @SchemaDef		VARCHAR(MAX) = '';

SELECT  @SchemaDef = @SchemaDef + SCHEMA_NAME(schema_id)
FROM	sys.tables
WHERE	name = @EntityName

SELECT  @CountRowsOut = @CountRowsOut + 
	N'SELECT COUNT(*) FROM ' + '[' + SCHEMA_NAME(schema_id) + '].[' + name + '];'
FROM	sys.tables
WHERE	name = @EntityName
EXEC(@CountRowsOut);
PRINT'		 </i></td>
...
PRINT'	 <tr>
		  <td colspan = "10"><div class = "footdetail_dep_samplerows">'

DECLARE @CountRowsCompare INT   
...
SELECT	@sSQL		= N'SELECT @CountRowsCompareOUT = COUNT(*) FROM [' + @SchemaDef + '].[' + @TableName + ']';  
SET		@ParmDef	= N'@CountRowsCompareOUT INT OUTPUT';

EXEC sp_executesql 
	@sSQL, 
	@ParmDef, 
	@CountRowsCompareOUT = @CountRowsCompare OUTPUT;

DECLARE @sql1 VARCHAR(MAX) = '';
DECLARE @sql2 VARCHAR(MAX) = '';
DECLARE @sql3 VARCHAR(MAX) = '';

IF @CountRowsCompare = 0
BEGIN
	PRINT 'No records'
END

ELSE IF @CountRowsCompare = 1
BEGIN
	--SELECT  @sql1 = @sql1 + 
	...
	SELECT  @sql1 = @sql1 + 
		 'SELECT TOP 1 * FROM ' + '[' + SCHEMA_NAME(T.schema_id) + '].[' + T.name + '];'
	FROM  sys.tables		T
	INNER JOIN sys.columns	C	ON	C.object_id			= T.object_id
	INNER JOIN sys.types	TP	ON	TP.system_type_id	= C.system_type_id
	WHERE T.name = @EntityName	AND TP.name != 'XML'
...
--WHERE T.name ='tblDownloadQuery_dgy' AND TP.name != 'XML'
...
BEGIN
	...
	SELECT  @sql2 = @sql2 + 
		 'SELECT TOP 2 * FROM ' + '[' + SCHEMA_NAME(T.schema_id) + '].[' + T.name + ']' + 'EXCEPT SELECT TOP 1 * FROM [' + SCHEMA_NAME(T.schema_id) + '].[' + T.name + '];'
	FROM  sys.tables		T
	INNER JOIN sys.columns	C	ON	C.object_id			= T.object_id
	INNER JOIN sys.types	TP	ON	TP.system_type_id	= C.system_type_id
	WHERE T.name = @EntityName	AND TP.name != 'XML'
...
BEGIN
	...
	SELECT  @sql3 = @sql3 + 
		 'SELECT TOP 3 * FROM ' + '[' + SCHEMA_NAME(T.schema_id) + '].[' + T.name + ']' + 'EXCEPT SELECT TOP 2 * FROM [' + SCHEMA_NAME(T.schema_id) + '].[' + T.name + '];'
	FROM  sys.tables		T
	INNER JOIN sys.columns	C	ON	C.object_id			= T.object_id
	INNER JOIN sys.types	TP	ON	TP.system_type_id	= C.system_type_id
	WHERE T.name = @EntityName	AND TP.name != 'XML'
...
PRINT '	<tr class = "trlinktop">
		<td colspan = "10"><span class = "linktop"><a href="#reportlinks">[Top]</a></span>		</td>
	</tr>
</tfoot>'
...
-- *** END SECTION: Display tables in the database
-- ****************************************************************************************************
...
-- ****************************************************************************************************
-- *** BEGIN SECTION: Display all STORED PROCEDURES in the database

-- *** Begin TOC: Display list of all STORED PROCEDURES in the database

PRINT '

<div id = "entitystoredprocedures">
<table class = "entitydesctbl">
    <tr class = "entitydescheadtr"><td colspan = "2">Stored Procedures</td></tr>
    <tr class = "entitydesctr">
        <td>The following section lists all STORED PROCEDURES within the <i>'
        + @DatabaseName + '</i> database</td><td class = "otherentypes"><a href="#reportlinks">Other entity types</a></td>
	 </tr>
</table>
</div>
...
-- *** End TOC: Display list of all STORED PROCEDURES in the database


-- *************************************************
-- *** BEGIN SECTION: Display STORED PROCEDURE data

DECLARE ObjData CURSOR
FOR

-- *** Begin constraint: Show only STORED PROCEDURES
...
-- *** End constraint: Show only STORED PROCEDURES

-- *** Begin Loop: Loop to display STORED PROCEDURES data
...
<thead>
	 <tr>
		  <th class = "entitydataviewsth" colspan = "1", white-space: nowrap><b>Stored Procedure Name: </b></th>
		  <td class = "entitydatanametd", colspan = "1"><div id = "' + @EntityName + '">' + @EntityName + '</div></td>
	 </tr>'
...
PRINT '	<tr>
			<th colspan = "2">Stored Procedure Definition</th>
	 </tr>
</thead>'

-- *** Display the STORED PROCEDURE definition

PRINT ''
PRINT '<tbody>

	<tr class = "entitydatasproctr">
		<td colspan = "2"><pre><code>' 
		EXEC dbo.sp_helptext @EntityName
PRINT '		</code></pre></td>
	</tr>'
...
-- *** End: Display all STORED PROCEDURES data
...
-- *** End Loop: Loop to display STORED PROCEDURES data

CLOSE		ObjData
DEALLOCATE	ObjData


-- *** END SECTION: Display all STORED PROCEDURES in the database
-- ****************************************************************************************************
...
-- ****************************************************************************************************
-- *** BEGIN SECTION: Display all FUNCTIONS in the database

-- *** Begin TOC: Display list of all FUNCTIONS in the database

PRINT '

<div id = "entityfunctions">
<table class = "entitydesctbl">
    <tr class = "entitydescheadtr"><td colspan = "2">Functions</td></tr>
    <tr class = "entitydesctr">
        <td>The following section lists all FUNCTIONS within the <i>'
        + @DatabaseName + '</i> database</td><td class = "otherentypes"><a href="#reportlinks">Other entity types</a></td>
	 </tr>
</table>
</div>
...
-- *** End TOC: Display list of all FUNCTIONS in the database


-- *****************************************
-- *** BEGIN SECTION: Display FUNCTION data

DECLARE ObjData CURSOR
FOR

-- *** Begin constraint: Show only FUNCTIONS
...
-- *** End constraint: Show only FUNCTIONS

-- *** Begin Loop: Loop to display FUNCTION data
...
<thead>
	 <tr>
		  <th class = "entitydataviewsth" colspan = "1", white-space: nowrap><b>Function Name: </b></th>
		  <td class = "entitydatanametd", colspan = "1"><div id = "' + @EntityName + '">' + @EntityName + '</div></td>
	 </tr>'
...
PRINT '	<tr>
			<th colspan = "2">Function Definition</th>
	 </tr>
</thead>'
...
-- *** End Loop: Loop to display FUNCTIONS data

CLOSE		ObjData
DEALLOCATE	ObjData


-- *** END SECTION: Display all FUNCTIONS in the database
-- ****************************************************************************************************
...
--		  <td class = "reporttitleimage"><img alt="Environmental Protection Agency Ireland" src = "https://www.edenireland.ie/Content/images/epa.png" width=75%; height=75%;></td>
 ...
 .entitydatadiv     {width:100%; display:inline-block; overflow:hidden;}
...
----PRINT ' <tr class = "footheader_dep_samplerows">
----		  <td colspan = "10">Records in <b>' + @EntityName + '</b>:</td>
----	 </tr>
----	 <tr>
----		  <td colspan = "10"><div class = "footdetail_dep_samplerows">'
...
----DECLARE @SortColumn1 NVARCHAR(128) = N'key_col';
----DECLARE @SortColumn2 NVARCHAR(128) = N'key_col';
----DECLARE @SortColumn3 NVARCHAR(128) = N'key_col';

------SELECT * FROM (SELECT ROW_NUMBER() OVER (ORDER BY @SortColumn1 ASC) AS rownumber, * FROM tblApprovalMeasurement_apm) AS foo WHERE rownumber = '1'

----SELECT  @sql4 = @sql4 +
----	 'SELECT * FROM (SELECT ROW_NUMBER() OVER (ORDER BY ' + @SortColumn1 + ' ASC) AS rownumber, * FROM ' 
----	 + '[' + SCHEMA_NAME(schema_id) + '].[' + name + ']' + ') AS foo WHERE rownumber = ''1'''
----FROM sys.tables
----WHERE name = @EntityName

----SELECT  @sql5 = @sql5 + 
----	 'SELECT * FROM (SELECT ROW_NUMBER() OVER (ORDER BY N''key_col'' ASC) AS rownumber, * FROM ' 
----	 + '[' + SCHEMA_NAME(schema_id) + '].[' + name + ']' + ') AS foo WHERE rownumber = ''2'''
----FROM sys.tables
----WHERE name = @EntityName

----SELECT  @sql6 = @sql6 + 
----	 'SELECT TOP 1 * FROM ' + '[' + SCHEMA_NAME(schema_id) + '].[' + name + ']' + ' ORDER BY NEWID();'
----FROM sys.tables
----WHERE name = @EntityName
