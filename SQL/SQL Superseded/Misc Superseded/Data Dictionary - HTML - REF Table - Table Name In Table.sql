...
--PRINT 'body	{font-family: Helvetica, sans-serif, Arial;}'
--PRINT 'h2		{color: #0000CC;}'
PRINT 'table	{border-collapse: collapse;}'
PRINT 'th	{padding: 3px; background: #BFEFFF; text-align: left;}'
PRINT 'td	{padding: 3px; background: #FDFCDC;}'
--PRINT 'table#t01 tr:nth-child(even)	{padding: 3px; background-color: #FDFCDC;}'
--PRINT 'table#t01 tr:nth-child(odd)	{padding: 3px; background-color: #FFFFFF;}'
...
PRINT '<tr><th colspan = "1", white-space: nowrap><b>Entity Name: </b></th><td colspan = "9">' + @TableName + '</td></tr>'
--Get the Description of the table
--Characters 1-250
PRINT '<tr><th colspan = "1", white-space: nowrap><i><b>Entity Description: </b></th><td colspan = "9">'
...
PRINT '<th><b>In PKey</b></th>'
PRINT '<th><b>Is FKey</b></th>'
