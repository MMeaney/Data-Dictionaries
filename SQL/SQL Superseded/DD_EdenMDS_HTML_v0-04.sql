...
PRINT ' body	 {color: black; background: #FFFFFF; font-family: sans-serif;}' -- Style 2
PRINT ' table	 {border-collapse: collapse;}'
PRINT ' table, th, td {border: 1px solid #A5A5A5; padding: 4px;}'
PRINT ' table td.entityname {background: #F5F5F5; font-size: 13px; font-weight: bold;}'
PRINT ' table td.entitydesc {background: #FFFFE0; font-size: 13px; font-style: italic;}'
PRINT ' table td.attname	 {background: #F5F5F5;}'
--PRINT '	th		{background: #BFEFFF; text-align: left;}' -- Style 1
--PRINT '	tr		{background: #FDFCDC;}' -- Style 1
PRINT ' th		{background: #757575; color: #FFFFFF; text-align: left; font-size: 13px;}' -- Style 2
PRINT ' tr		{background: #FFFFFF;}' -- Style 2
...
PRINT ' tbody tr.hov		{font-size: 12px;}' -- Style 2
PRINT ' tbody tr.hov:hover	{background: #F5F5F5;  color: #161A1D;}'
--PRINT '	tfoot tr.footheader	 {background: #BFEFFF; text-align: left; font-weight: bold;}' -- Style 1
PRINT ' tfoot tr.footheader	{background: #FFEECC; text-align: left; font-size: 13px; font-weight: bold;}' -- Style 2
PRINT ' tfoot tr.footdetail	{background: #FFFFFF; text-align: left; font-size: 12px;}' -- Style 2
PRINT ' tfoot tr.footdetail:hover	{background: #F5F5F5;  color: #161A1D;}'
PRINT ' dl	{padding: 4px; background: #F5F5F5}' -- Style 2
...
PRINT ' div#entitytoc		{font-size: 13px;}' -- Style 2
PRINT ' div#reporttitle	{font-size: 30px;}'
...
PRINT '<tr><th>Database: </th><td>' + @DatabaseName + '</td></tr>'
PRINT '<tr><th>Server: </th><td>' + @ServerName + '</td></tr>'
PRINT '<tr><th>Generated on: </th><td>' + CAST(@TimeGenerated AS NVARCHAR(50)) + '</td></tr>'
PRINT '</table>'
PRINT '<br/>'
PRINT '<br/>'
...
PRINT '<dl>'
PRINT '<dt>The following entities contain foreign keys, and are therefore related to one or more other entities within the database.</dt>'
--PRINT '<br/>'
PRINT '<dd>Entities that do not contain foreign keys are listed <a href="#entitynofk">here</a></dd>'
PRINT '</dl>'
PRINT '</div>'
--PRINT '<br/>'
--PRINT '<br/>'

PRINT '<div id = "entitytoc">'
PRINT '<ul>' -- Style 2

WHILE @@FETCH_STATUS = 0 BEGIN
--PRINT '	<tr class = "entitytoctr">' -- Style 1
--PRINT '		<td class = "entitytoctd">' -- Style 1
...
PRINT '		<td class = "entityname", colspan = "8"><div id = "' + @EntityName + '">' + @EntityName + '</div></td>'
PRINT '	</tr>'
...
PRINT '		<td class = "entitydesc", colspan = "8">'
...
PRINT '		<th>Length</th>'
--PRINT '<th><b>Numeric Precision</th>'
--PRINT '<th><b>Numeric Scale</th>'
PRINT '		<th>Nullable</th>'
--PRINT '<th><b>Computed</th>'
--PRINT '<th><b>Identity</th>'
PRINT '		<th>Default</th>'
PRINT '		<th>FK Dependencies</th>'
--PRINT '		<th>Table Name (TEMP Field)</th>'
PRINT '	</tr>'
PRINT '</thead>'
...
SELECT
	'	<tr class = "hov">' + 
	'		<td class = "attname">' + CAST(clmns.name AS VARCHAR(50)) + '</td>'
