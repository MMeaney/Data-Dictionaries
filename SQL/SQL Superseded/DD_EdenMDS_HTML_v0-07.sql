...
'
 ...
 span:hover             {background:#F5F5F5; color:#161A1D;}
 .entitytoc li:hover    {background:#F5F5F5; color:#161A1D;}
 .otherentypes:hover	  {background:#F5F5F5; color:#161A1D; font-style:italic;}
 .entitydatatr:hover	  {background:#F5F5F5; color:#161A1D;}
 .entitydatadiv:hover   {box-shadow:2px 2px 10px 2px #D6D6D6;}
 a:hover                {color:#161A1D;}
...
<thead>
	 <tr>
		  ...
		  <td class = "entitydatanametd", colspan = "14"><div id = "' + @EntityName + '">' + @EntityName + '</div></td>
	 </tr>'

-- *** Table Description - Characters 1-250
PRINT '	<tr>
		  <th colspan = "1", white-space: nowrap><i><b>Entity Description: </b></i></th>
				<td class = "entitydatadesctd", colspan = "14">'
...
PRINT '	<tr>
		  <th colspan = "1", white-space: nowrap><i>Entity System: </i></th>
				<td class = "entitydatasystd", colspan = "14">'
...
PRINT '	<tr class = "trlinktop"><td colspan = "14"><span class = "linktop"><a href="#reportlinks">[Top]</a></span></td></tr>'
PRINT '</tfoot>'
...
PRINT '	<tr>
		  <th colspan = "1", white-space: nowrap><i><b>Entity Description: </b></i></th>
				<td class = "entitydatadesctd", colspan = "10">'
...
PRINT '	<tr>
		  <th colspan = "1", white-space: nowrap><i>Entity System: </i></th>
				<td class = "entitydatasystd", colspan = "10">'
